...
scope:
  ...
  exclude:
    ...
    - ".punk/**"
acceptance:
  - "Advisory Work Ledger Review is completed after file IO artifact hashing boundary v0.1 is defined."
  - "Review identifies whether the next safest branch is file IO hash helper implementation, referenced artifact verification policy, proofpack writer preparation, another docs/spec guardrail, or another active-core setup step."
...
File IO artifact hashing boundary v0.1 is now defined as docs/spec.

Before selecting file IO hash helper implementation, referenced artifact verification policy, proofpack writer preparation, runtime storage/schema/CLI work, or gate/eval/proof orchestration, run a short advisory review of the work ledger and open blockers.
