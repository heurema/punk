...
scope:
  ...
  exclude:
    ...
    - "schemas/**"
acceptance:
  - "Advisory Work Ledger Review is completed after proofpack writer target path policy model v0.1 is implemented."
...
Proofpack writer target path policy model v0.1 is implemented as side-effect-free `punk-proof` behavior.
