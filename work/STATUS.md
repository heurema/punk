...
current_focus: "Run the thirty-seventh advisory Work Ledger Review"
selected_next: "work/goals/goal_run_thirty_seventh_work_ledger_review.md"
...
- Current focus: run the thirty-seventh advisory Work Ledger Review.
- Selected next: `work/goals/goal_run_thirty_seventh_work_ledger_review.md`
- Why this is next: proofpack writer storage/schema boundary v0.1 is defined; run the next advisory ledger review before selecting proofpack writer implementation, `.punk/proofs` activation, schema files, proofpack referenced-ref verification integration implementation, CLI behavior, gate decisions, acceptance claims, adapters, automation, provider/model runners, or `punk init`.
- Acceptance:
  - advisory review evaluates the latest proofpack writer storage/schema boundary and open blockers.
