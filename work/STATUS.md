...
current_focus: "Run the fortieth advisory Work Ledger Review"
selected_next: "work/goals/goal_run_fortieth_work_ledger_review.md"
...
- Current focus: run the fortieth advisory Work Ledger Review.
- Selected next: `work/goals/goal_run_fortieth_work_ledger_review.md`
- Why this is next: proofpack writer preflight plan model v0.1 is implemented as side-effect-free code; run the next advisory ledger review before selecting proofpack file writer preparation, `.punk/proofs` activation, schema files, proofpack referenced-ref verification integration implementation, CLI behavior, gate decisions, acceptance claims, adapters, automation, provider/model runners, or `punk init`.
- Acceptance:
  - advisory review evaluates the latest proofpack writer preflight plan model and open blockers.
