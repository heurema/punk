...
- keep the implemented CLI truth limited to `punk init <project-id>`, `punk init <project-id> --mode brownfield`, `punk flow inspect`, `punk eval run smoke`, and `punk eval run smoke --format json`.
