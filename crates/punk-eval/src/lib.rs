...
use punk_module_host::{
    propose_module_assessment_receipt, wrap_module_assessment, ModuleCapabilityGrant,
    ModuleHostStatus, ModuleInvocationEnvelope, ModuleOutputAuthority, ModuleOutputBoundaryFlags,
    ModuleOutputStatus, ModuleOutputSummary, ModuleReceiptProposalField,
};
use punk_project::{
...
mod tests {
    ...
    fn smoke_report_contains_expected_summary_and_cases() {
        ...
        assert_eq!(report.cases().len(), 154);
    }
