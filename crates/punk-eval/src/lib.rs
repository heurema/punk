...
use punk_mod_pubpunk::{
    ...
    PubPunkPublishOperationEvidenceHandoffPacket, PubPunkPublishReceiptPreflightPacket,
...
mod tests {
    ...
    fn smoke_report_contains_expected_summary_and_cases() {
        ...
        assert_eq!(report.cases().len(), 173);
    }
