...
use punk_module_host::{
    ...
    ModuleSideEffectPrecondition, ModuleSideEffectReceiptWriterFileIoFailureVisibility,
...
mod tests {
    ...
    fn smoke_report_contains_expected_summary_and_cases() {
        ...
        assert_eq!(report.cases().len(), 161);
    }
