...
use punk_module_host::{
    ...
    propose_module_side_effect_request, wrap_module_assessment,
...
mod tests {
    ...
    fn smoke_report_contains_expected_summary_and_cases() {
        ...
        assert_eq!(report.cases().len(), 167);
    }
