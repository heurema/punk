...
| `punk-module-host` | incubating | pure module invocation envelope, receipt proposal, side-effect request proposal, policy gate preflight, side-effect receipt writer preflight, side-effect receipt writer active behavior, side-effect receipt writer file IO plan, and target/storage policy readiness models |
