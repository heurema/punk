...
17. `docs/product/BROWNFIELD-SOURCE-CORPUS-MANIFEST.md`
18. `docs/product/DOC-GOVERNANCE.md`
19. `docs/product/PUBLIC-NARRATIVE.md`
20. `docs/product/LINEAGE.md`
21. `docs/adr/`
22. `knowledge/research/`
23. `knowledge/ideas/`
24. `work/goals/` and `work/reports/`
25. `publishing/`
...
| Plot Intake boundary proposal | `docs/product/PLOT-INTAKE.md` | `docs/product/ARCHITECTURE.md`, `docs/product/CONTRACT-SCHEMA.md`, `docs/product/RUNNER-AIDS.md`, `docs/product/MODULES.md`, `knowledge/research/2026-05-19-plot-intake-boundary-prior-art.md`, `evals/specs/plot-intake-boundary.v0.1.md`, `evals/specs/plot-intake-routing-recommendation.v0.1.md`, `evals/specs/plot-intake-evidence-plan.v0.1.md` | Draft upstream boundary inside `plot`; advisory contract-draft readiness, harness slash-command bridge candidate, phase/module routing recommendation, and no runtime/CLI/module authority. |
| Module Authoring Baseline | `docs/product/MODULE-AUTHORING.md` | `docs/product/MODULES.md`, `docs/product/MODULE-HOST.md`, `docs/product/MODULE-CONTROL-PLANE.md`, `docs/product/DELIBERATION-BUDGET.md`, `evals/specs/module-authoring-baseline.v0.1.md`, `evals/specs/module-control-plane.v0.1.md`, `evals/specs/module-naming-baseline.v0.1.md` | Shared module authoring, naming, and conformance direction before DevPunk, PubPunk, or future modules. |
| Module Control Plane | `docs/product/MODULE-CONTROL-PLANE.md` | `docs/product/MODULE-CONTROL-VALIDATION.md`, `docs/product/MODULE-TUNING-HANDOFF-TEMPLATE.md`, `docs/product/MODULE-AUTHORING.md`, `docs/product/MODULE-HOST-CONTRACT.md`, `docs/product/MODULE-CONFORMANCE.md`, `docs/product/INSTRUCTION-SOURCES.md`, `knowledge/research/2026-05-21-adaptive-module-control-plane.md`, `evals/specs/module-control-plane.v0.1.md`, `evals/specs/module-control-validation.v0.1.md`, `evals/specs/module-tuning-handoff-template.v0.1.md` | Advisory module control manifest, behavior artifact, behavior overlay stack, user-local behavior artifact, manual in-session tuning, tuning proposal, behavior artifact promotion packet, propose-only reflection, and behavior-provenance boundary; no runtime, parser, scheduler, writer, adapter, gate, proof, or acceptance authority. |
| Module Control Validation | `docs/product/MODULE-CONTROL-VALIDATION.md` | `docs/product/MODULE-CONTROL-PLANE.md`, `docs/product/MODULE-TUNING-HANDOFF-TEMPLATE.md`, `docs/product/MODULE-AUTHORING.md`, `docs/product/MODULE-CONFORMANCE.md`, `docs/modules/pubpunk-control-manifest.md`, `docs/modules/pubpunk-article-hook-tuning-fixture.md`, `docs/modules/pubpunk-live-tuning-runbook.md`, `docs/modules/pubpunk-live-tuning-handoff-template.md`, `docs/modules/pubpunk-article-hook-live-tuning-handoff-example.md`, `evals/specs/module-control-validation.v0.1.md`, `evals/specs/module-tuning-handoff-template.v0.1.md`, `evals/specs/module-control-plane.v0.1.md`, `evals/specs/pubpunk-control-manifest.v0.1.md`, `evals/specs/pubpunk-article-hook-tuning-fixture.v0.1.md`, `evals/specs/pubpunk-live-tuning-runbook.v0.1.md`, `evals/specs/pubpunk-live-tuning-handoff-template.v0.1.md`, `evals/specs/pubpunk-article-hook-live-tuning-handoff-example.v0.1.md` | Operator runbook for current Module Control Plane marker checks, command routing through one consolidated checker, failure handling, and non-authoritative validation meaning; no runtime, parser, resolver, writer, scheduler, adapter, publishing, event, gate, proof, or acceptance authority. |
| Module Tuning Handoff Template | `docs/product/MODULE-TUNING-HANDOFF-TEMPLATE.md` | `docs/product/MODULE-CONTROL-PLANE.md`, `docs/product/MODULE-CONTROL-VALIDATION.md`, `docs/modules/pubpunk-live-tuning-handoff-template.md`, `knowledge/research/2026-05-21-adaptive-module-control-plane.md`, `evals/specs/module-tuning-handoff-template.v0.1.md`, `evals/specs/module-control-validation.v0.1.md`, `evals/specs/module-control-plane.v0.1.md` | Generic proposal-only handoff template for text, voice, or scheduled-proposal module tuning sessions; no runtime, parser, resolver, writer, scheduler, adapter, publishing, event, gate, proof, or acceptance authority. |
| Module Conformance Packet | `docs/product/MODULE-CONFORMANCE.md` | `docs/product/MODULE-AUTHORING.md`, `docs/product/MODULES.md`, `docs/product/MODULE-HOST.md`, `evals/specs/module-conformance-packet.v0.1.md` | Advisory module readiness packet before DevPunk, PubPunk, or future module implementation. |
| Module Host Contract Stub | `docs/product/MODULE-HOST-CONTRACT.md` | `docs/product/MODULE-HOST.md`, `docs/product/MODULE-CONFORMANCE.md`, `evals/specs/module-host-contract-stub.v0.1.md` | Advisory host input/output, capability envelope, side-effect request, and event-log boundary before module skeletons. |
| Codebase Study module boundary | `docs/modules/codebase-study.md` | `docs/product/MODULES.md`, `docs/product/MODULE-AUTHORING.md`, `docs/product/MODULE-HOST-CONTRACT.md`, `docs/product/BROWNFIELD-INVENTORY.md`, `docs/product/BROWNFIELD-SOURCE-CORPUS-MANIFEST.md`, `evals/specs/codebase-study-module-boundary.v0.1.md`, `evals/specs/brownfield-inventory-boundary.v0.1.md`, `evals/specs/brownfield-source-corpus-manifest-boundary.v0.1.md` | Parked source-observation module boundary; explicit source observation request to advisory observation packet only, with no scanner, file walker, content reader, manifest builder, runtime storage, module execution, gate/proof, or acceptance authority. |
| PubPunk module boundary | `docs/modules/pubpunk.md` | `docs/modules/pubpunk-workspace-instructions.md`, `docs/modules/pubpunk-control-manifest.md`, `docs/modules/pubpunk-article-hook-tuning-fixture.md`, `docs/modules/pubpunk-live-tuning-runbook.md`, `docs/modules/pubpunk-live-tuning-handoff-template.md`, `docs/modules/pubpunk-article-hook-live-tuning-handoff-example.md`, `docs/product/MODULE-AUTHORING.md`, `docs/product/MODULE-CONFORMANCE.md`, `docs/product/MODULE-HOST-CONTRACT.md`, `docs/product/MODULE-CONTROL-PLANE.md`, `evals/specs/pubpunk-workspace-instruction-packet.v0.1.md`, `evals/specs/pubpunk-control-manifest.v0.1.md`, `evals/specs/pubpunk-article-hook-tuning-fixture.v0.1.md`, `evals/specs/pubpunk-live-tuning-runbook.v0.1.md`, `evals/specs/pubpunk-live-tuning-handoff-template.v0.1.md`, `evals/specs/pubpunk-article-hook-live-tuning-handoff-example.v0.1.md`, `evals/specs/pubpunk-inventory-reader.v0.1.md`, `evals/specs/pubpunk-inventory-input-packet.v0.1.md`, `evals/specs/pubpunk-host-handoff.v0.1.md`, `evals/specs/pubpunk-channel-connector-profile-resolution.v0.1.md`, `evals/specs/pubpunk-publish-request-packet.v0.1.md`, `evals/specs/pubpunk-publish-receipt-preflight.v0.1.md`, `evals/specs/pubpunk-publish-receipt-write-handoff.v0.1.md`, `evals/specs/pubpunk-publish-operation-evidence-handoff.v0.1.md`, `evals/specs/pubpunk-publish-receipt-evidence-event-handoff.v0.1.md` | Incubating content/publishing module boundary; current code is reader, input-packet, inventory-assessment, channel-connector-profile-resolution, host-handoff, publish-request-packet, publish-receipt-preflight, publish-receipt-write-handoff, publish-operation-evidence-handoff, and publish-receipt/evidence-event-handoff smoke evidence only, with advisory control manifest, article-hook tuning fixture, live tuning runbook, live tuning handoff template, and article-hook live tuning handoff example, and no runtime, CLI, publishing, metrics, adapter invocation, PubPunk-owned receipt/evidence writing, direct event-log mutation, gate/proof writing, or acceptance authority. |
...
| Deliberation Budget boundary | `docs/product/DELIBERATION-BUDGET.md` | `docs/product/PLOT-INTAKE.md`, `docs/product/RUNNER-AIDS.md`, `docs/product/REVIEW-ASSESSMENT.md`, `docs/product/MODULES.md`, `evals/specs/deliberation-budget-boundary.v0.1.md` | Intentional multi-perspective advisory passes and synthesis; no provider runtime or decision authority. |
...
| Brownfield Inventory boundary | `docs/product/BROWNFIELD-INVENTORY.md` | `docs/product/PROJECT-MEMORY.md`, `docs/product/ROADMAP.md`, `evals/specs/brownfield-inventory-boundary.v0.1.md` | Defines future brownfield inventory and source inventory observation packets as advisory observable structure only, separate from claims, intent, contracts, decisions, proof, scanner activation, and benchmark authority. |
| Brownfield Source Corpus Manifest design and writer boundaries | `docs/product/BROWNFIELD-SOURCE-CORPUS-MANIFEST.md` | `docs/product/BROWNFIELD-INVENTORY.md`, `evals/specs/brownfield-source-corpus-manifest-boundary.v0.1.md` | Defines future manifest schema, path/content/hash/source-class policies, observation-packet handoff, source corpus manifest writer boundary, and writer implementation boundary before any scanner, writer implementation, or source inventory generation is selected. |
