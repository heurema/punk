...
| Brownfield Source Corpus Manifest design and writer boundaries | `docs/product/BROWNFIELD-SOURCE-CORPUS-MANIFEST.md` | `docs/product/BROWNFIELD-INVENTORY.md`, `evals/specs/brownfield-source-corpus-manifest-boundary.v0.1.md` | Defines future manifest schema, path/content/hash/source-class policies, source corpus manifest writer boundary, and writer implementation boundary before any scanner, writer implementation, or source inventory generation is selected. |
