...
| Brownfield Source Corpus Manifest design and writer boundary | `docs/product/BROWNFIELD-SOURCE-CORPUS-MANIFEST.md` | `docs/product/BROWNFIELD-INVENTORY.md`, `evals/specs/brownfield-source-corpus-manifest-boundary.v0.1.md` | Defines future manifest schema, path/content/hash/source-class policies, and source corpus manifest writer boundary before any scanner, writer implementation, or source inventory generation is selected. |
