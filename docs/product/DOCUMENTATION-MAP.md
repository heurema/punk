...
| Brownfield Source Corpus Manifest design | `docs/product/BROWNFIELD-SOURCE-CORPUS-MANIFEST.md` | `docs/product/BROWNFIELD-INVENTORY.md`, `evals/specs/brownfield-source-corpus-manifest-boundary.v0.1.md` | Defines future manifest schema and path/content/hash/source-class policies before any scanner, writer, or implementation is selected. |
