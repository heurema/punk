...
| Module Authoring Baseline | `docs/product/MODULE-AUTHORING.md` | `docs/product/MODULES.md`, `docs/product/MODULE-HOST.md`, `docs/product/DELIBERATION-BUDGET.md`, `evals/specs/module-authoring-baseline.v0.1.md`, `evals/specs/module-naming-baseline.v0.1.md` | Shared module authoring, naming, and conformance direction before DevPunk, PubPunk, or future modules. |
...
| PubPunk module boundary | `docs/modules/pubpunk.md` | `docs/modules/pubpunk-workspace-instructions.md`, `docs/product/MODULE-AUTHORING.md`, `docs/product/MODULE-CONFORMANCE.md`, `docs/product/MODULE-HOST-CONTRACT.md`, `evals/specs/pubpunk-workspace-instruction-packet.v0.1.md`, `evals/specs/pubpunk-inventory-reader.v0.1.md`, `evals/specs/pubpunk-inventory-input-packet.v0.1.md`, `evals/specs/pubpunk-host-handoff.v0.1.md`, `evals/specs/pubpunk-channel-connector-profile-resolution.v0.1.md`, `evals/specs/pubpunk-publish-request-packet.v0.1.md`, `evals/specs/pubpunk-publish-receipt-preflight.v0.1.md`, `evals/specs/pubpunk-publish-receipt-write-handoff.v0.1.md`, `evals/specs/pubpunk-publish-operation-evidence-handoff.v0.1.md`, `evals/specs/pubpunk-publish-receipt-evidence-event-handoff.v0.1.md` | Incubating content/publishing module boundary; current code is reader, input-packet, inventory-assessment, channel-connector-profile-resolution, host-handoff, publish-request-packet, publish-receipt-preflight, publish-receipt-write-handoff, publish-operation-evidence-handoff, and publish-receipt/evidence-event-handoff smoke evidence only, with no runtime, CLI, publishing, metrics, adapter invocation, PubPunk-owned receipt/evidence writing, direct event-log mutation, gate/proof writing, or acceptance authority. |
