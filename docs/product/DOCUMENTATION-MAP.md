...
| PubPunk module boundary | `docs/modules/pubpunk.md` | `docs/modules/pubpunk-workspace-instructions.md`, `docs/product/MODULE-AUTHORING.md`, `docs/product/MODULE-CONFORMANCE.md`, `docs/product/MODULE-HOST-CONTRACT.md`, `evals/specs/pubpunk-workspace-instruction-packet.v0.1.md`, `evals/specs/pubpunk-inventory-reader.v0.1.md`, `evals/specs/pubpunk-inventory-input-packet.v0.1.md`, `evals/specs/pubpunk-host-handoff.v0.1.md` | Incubating content/publishing module boundary; current code is reader, input-packet, inventory-assessment, and host-handoff smoke evidence only, with no runtime, CLI, publishing, metrics, or receipt writer. |
